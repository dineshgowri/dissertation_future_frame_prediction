...
class GroundTruthLoader(object):
    ...
    ## Cross dataset code changes for StreetScene
    STREETSCENE = 'streetscene'
    STREETSCENE_LABEL_PATH = os.path.join(DATA_DIR, 'streetscene/testing/test_frame_mask')
    STREETSCENE_PIXEL_MASK_PATH = os.path.join(DATA_DIR, 'streetscene/testing/pixel_masks')
    ...
    NAME_FRAMES_MAPPING = {
        ...
        STREETSCENE: os.path.join(DATA_DIR, 'streetscene/testing/frames'),
    }
    ...
    def __call__(self, dataset):
        ...
        elif dataset == GroundTruthLoader.STREETSCENE:
            gt = self.__load_streetscene_gt()
        else:
